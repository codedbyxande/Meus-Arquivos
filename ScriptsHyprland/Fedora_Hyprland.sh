...
sudo dnf install -y hyprland fuzzel  kitty git hyprland-devel flatpak fastfetch # Replaced gnome-shell, gdm with hyprland, fuzzel and added nautilus, kitty, git, flatpak, fastfetch similar to other scripts

...
paru -S --noconfirm hyprland fuzzel kitty git flatpak base-devel swaybg  nwg-look nwg-displays pop-icon-theme visual-studio-code-bin fastfetch  || { echo -e "${YELLOW}Falha ao instalar Hyprland e utilitários!${NC}"; exit 1; }

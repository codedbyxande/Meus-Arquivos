...
sudo dnf install -y hyprland fuzzel  kitty git hyprland-devel flatpak fastfetch 

echo -e "${CYAN}\n===== INSTALANDO AGS-HYPRPANEL E WAYPAPER =====${NC}"
flatpak install -y flathub com.github.Aylur.ags
flatpak install -y flathub io.github.anufrievroman.Waypaper

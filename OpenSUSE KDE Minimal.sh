...
sudo env ZYPP_PCK_PRELOAD=1 zypper in -y plasma6-desktop dolphin flatpak fastfetch dolphin-plugins ffmpegthumbs ark sddm || { echo -e "${YELLOW}Falha ao instalar KDE Plasma 6 minimalista!${NC}"; exit 1; }

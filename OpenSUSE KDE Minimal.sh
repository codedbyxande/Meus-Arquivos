...
sudo env ZYPP_PCK_PRELOAD=1 zypper in -y plasma-desktop sddm dolphin dolphin-plugins kitty ark git flatpak code fastfetch || { echo -e "${YELLOW}Falha ao instalar KDE Plasma!${NC}"; exit 1; }
